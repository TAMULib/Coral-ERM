...
<?php 
// Disable for Demo Site 
//<span id='span_newUser' class='adminAddInput'><a href='ajax_forms.php?action=getAdminUserUpdateForm&height=196&width=248&modal=true' class='thickbox' id='expression'><?php echo _("add new user");</a></span> ?>
<br /><br />
<?php 
// Disable for Demo Site 
//	<div id='div_User'>
