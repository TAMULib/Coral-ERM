...
<?php // Disable for Demo Site <br /><span id='span_newUser' class='adminAddInput'><a href='ajax_forms.php?action=getAdminUserUpdateForm&height=202&width=288&modal=true' class='thickbox' id='expression'><?php echo _("add new user");?><?php //</a></span> ?>
<br /><br />
<div id='div_User'>
