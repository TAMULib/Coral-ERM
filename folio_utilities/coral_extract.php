...
//		echo "<br>";		
		...
		$sql2 = "SELECT * FROM ResourceNote where entityID = " . $row['resourceID'] . " AND noteTypeID = 6"; 
		...
		$sql2 = "SELECT * FROM ResourceNote where entityID = " . $row['resourceID'] . " AND noteTypeID = 7"; 
		$rs2 = mysqli_query($conn, $sql2 );
		$row2 = mysqli_fetch_array( $rs2 );
