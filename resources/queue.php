...
<?php
foreach ($tabs as $tab) {
	echo "<tr><td><div class='queueMenuLink'><a href='#' id='{$tab['id']}'>"._($tab['text'])."</a></div><span class='span_".$tab['spanClass']." smallGreyText' style='clear:right; margin-left:10px;'></span></td></tr>";
}
?>
			</table>
		</td>
