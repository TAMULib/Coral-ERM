<?php
		...
		$resourceArray = array();
		$resourceArray = $user->getResourcesInQueue('completed');

		echo "<div class='adminRightHeader'>"._("Completed Requests")."</div>";



		if (count($resourceArray) == "0"){
			echo "<i>"._("No archived requests")."</i>";
		}else{
		?>
		...
		?>
				<tr id='tr_<?php echo $resource['resourceID']; ?>'>
					<td <?php echo $classAdd; ?>><a href='ajax_forms.php?action=getUpdateProductForm&height=483&width=775&resourceID=<?php echo $resource['resourceID']; ?>&modal=true' class='thickbox'><?php echo $resource['resourceID']; ?></a></td>
					<td <?php echo $classAdd; ?>><a href='ajax_forms.php?action=getUpdateProductForm&height=483&width=775&resourceID=<?php echo $resource['resourceID']; ?>&modal=true' class='thickbox'><?php echo $resource['titleText']; ?></a></td>
					...
					<a href='ajax_forms.php?action=getUpdateProductForm&height=483&width=775&resourceID=<?php echo $resource['resourceID']; ?>&modal=true' class='thickbox'><img src='images/edit.gif' alt='<?php echo _("edit");?>' title='<?php echo _("edit request");?>'></a>&nbsp;
